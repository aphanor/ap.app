var AP=angular.module("AP",[]);AP.controller("EmailCtrl",["$scope","$http",function(o,l){o.submitEmail=function(){l.post("/email",o.email).success(function(o,l){console.log("Sent ok: "+o)}).error(function(o,l){console.log("Error: "+o)})}}]);
...
$(document).ready(function(){function e(){n=setTimeout(function(){$("div.main").moveTo(2)},4400)}function o(){clearTimeout(n)}$(".down").click(function(){$("div.main").moveDown()}),$(".up").click(function(){$("div.main").moveUp()}),setTimeout(function(){$(".scroll").fadeIn(1e3)},1e3);var n;$.cookie("cookie")?$(".logo svg").hide():($.cookie("cookie","1",{expires:1,path:"/"}),e()),$("button.button--sacnite").click(function(){o()}),$("div.main").onepage_scroll({sectionContainer:"section",easing:"ease-in-out",animationTime:1e3,pagination:!0,updateURL:!1,beforeMove:function(e){},afterMove:function(e){function o(){$("section.info").visible(!0)&&($(".rowi").fadeIn(800),$(".pie_progress").asPieProgress("start"),$(".pie_progressi").asPieProgress("start"),$(".pie_progresso").asPieProgress("start"),$(".pie_progressa").asPieProgress("start"),$(".pie_progressu").asPieProgress("start"))}o(),clearTimeout(n),/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?($("section.project-planner").hide(),$(".img_container").hide()):$("section.project-planner").visible(!0)&&$("div#projectplannerformarea").slideDown(500,"swing"),$("button.button--sacnite").addClass("bounce"),$("body").on({mouseenter:function(){$(this).find("button.button--sacnite").removeClass("bounce"),clearTimeout(n)},mouseleave:function(){$(this).find("button.button--sacnite").addClass("bounce")}},"button.button--sacnite")},loop:!1,keyboard:!0,responsiveFallback:!1,direction:"vertical"}),function(e){"use strict";function o(e,o){var n=e.length,t=360*o;t%=360;var i=t*Math.PI/180,r=125*Math.sin(i),a=-125*Math.cos(i),s=t>180?1:0,c="M 0 0 v -125 A 125 125 1 "+s+" 1 "+r+" "+a+" z";if(e instanceof Array)for(;n--;)e[n].setAttribute("d",c);else e.setAttribute("d",c)}Date.now=Date.now||function(){return+new Date},e.svgPieTimer=function(e){var n=e.element,t=e.duration||1e3,i=e.loops;if(!n)throw"SVG Pie Timer: Error - element required";i=0==i?0:i?i:1;var r=Date.now()+t*i,a=t*i;!function s(){var e=Date.now(),c=r-e,u=i+1-c/t;60>c&&(o(n,i-1e-4),a>c&&i)||(o(n,u),requestAnimationFrame(s))}()}}(window,void 0);var t=document.getElementById("loader"),i=document.getElementById("border");svgPieTimer({element:[t,i],duration:4e3,loops:1})});
