...
$(document).ready(function(){function e(){n=setTimeout(function(){$("div.main").moveTo(2)},4400)}$(".down").click(function(){$("div.main").moveDown()}),$(".up").click(function(){$("div.main").moveUp()}),setTimeout(function(){$(".scroll").fadeIn(1e3)},1e3);$("div.main").onepage_scroll({sectionContainer:"section",easing:"ease-in-out",animationTime:1e3,pagination:!0,updateURL:!1,beforeMove:function(e){},afterMove:function(e){function t(){$("section.info").visible(!0)&&($(".pie_progress").asPieProgress("start"),$(".pie_progressi").asPieProgress("start"),$(".pie_progresso").asPieProgress("start"),$(".pie_progressa").asPieProgress("start"),$(".pie_progressu").asPieProgress("start"))}t(),clearTimeout(n),$("section.project-planner").visible(!0)&&$("div#projectplannerformarea").slideDown(500,"swing"),$("button.button--sacnite").addClass("bounce"),$(".contact").hover(function(){$("button.button--sacnite").removeClass("bounce"),clearTimeout(n)}),$(".contact").click(function(){clearTimeout(n),StopInterval()})},loop:!1,keyboard:!0,responsiveFallback:!1,direction:"vertical"}),function(e){"use strict";function t(e,t){var o=e.length,n=360*t;n%=360;var i=n*Math.PI/180,r=125*Math.sin(i),a=-125*Math.cos(i),s=n>180?1:0,c="M 0 0 v -125 A 125 125 1 "+s+" 1 "+r+" "+a+" z";if(e instanceof Array)for(;o--;)e[o].setAttribute("d",c);else e.setAttribute("d",c)}Date.now=Date.now||function(){return+new Date},e.svgPieTimer=function(e){var o=e.element,n=e.duration||1e3,i=e.loops;if(!o)throw"SVG Pie Timer: Error - element required";i=0==i?0:i?i:1;var r=Date.now()+n*i,a=n*i;!function s(){var e=Date.now(),c=r-e,u=i+1-c/n;60>c&&(t(o,i-1e-4),a>c&&i)||(t(o,u),requestAnimationFrame(s))}()}}(window,void 0);var t=document.getElementById("loader"),o=document.getElementById("border");svgPieTimer({element:[t,o],duration:4e3,loops:1});var n;e()});
